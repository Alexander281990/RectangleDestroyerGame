...
public class LevelScreen_29 extends LevelScreenMain {
    ...
    public void initialize() {
        ...
        showModalScreen(29, recordsLevel_29, "rules_level_screen/level_screen_29_ru.txt",
                "rules_level_screen/level_screen_29.txt");
    ...
    public void update(float dt) {
        ...
        if (BaseActor.count(mainStage, "alex.iv.rect.destroy.actors.Brick") == 0 && starTimer > 0) {
            allTheBricksAreBroken("records_29");// инициализируем метод allTheBricksAreBroken - ВСЕ КИРПИЧИ РАЗРУШЕНЫ
            RectangleGame.setActiveScreen(new VictoryScreen(requestHandler, "attainmentColorLevelMemory_29"));
        }
