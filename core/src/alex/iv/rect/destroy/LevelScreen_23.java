...
public class LevelScreen_23 extends LevelScreenMain {
    ...
    // MenuScreen
    public LevelScreen_23(IActivityRequestHandler requestHandler) {
    ...
    public void initialize() {
        ...
        showModalScreen(23, recordsLevel_23, "rules_level_screen/level_screen_23_ru.txt",
                "rules_level_screen/level_screen_23.txt");
    ...
    public void update(float dt) {
        ...
        if (starTimer < 0) {
            timeIsUp(recordsLevel_23, "records_23"); // инициализируем метод timeIsUp - ВРЕМЯ ВЫШЛО
            RectangleGame.setActiveScreen(new IntermediateScreen(requestHandler, 23, score));
        }
        if (BaseActor.count(mainStage, "alex.iv.rect.destroy.actors.Brick") == 0 && starTimer > 0) {
            allTheBricksAreBroken("records_23");// инициализируем метод allTheBricksAreBroken - ВСЕ КИРПИЧИ РАЗРУШЕНЫ
            RectangleGame.setActiveScreen(new VictoryScreen(requestHandler, "attainmentColorLevelMemory_23"));
        }
