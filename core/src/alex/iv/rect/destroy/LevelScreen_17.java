...
public class LevelScreen_17 extends LevelScreenMain {
    ...
    public void initialize() {
        ...
        showModalScreen(17, recordsLevel_17, "rules_level_screen/level_screen_17_ru.txt",
                "rules_level_screen/level_screen_17.txt");
    ...
    public void update(float dt) {
        ...
        if (BaseActor.count(mainStage, "alex.iv.rect.destroy.actors.Brick") == 0 && starTimer > 0) {
            allTheBricksAreBroken("records_17");// инициализируем метод allTheBricksAreBroken - ВСЕ КИРПИЧИ РАЗРУШЕНЫ
            RectangleGame.setActiveScreen(new VictoryScreen(requestHandler, "attainmentColorLevelMemory_17"));
        }
